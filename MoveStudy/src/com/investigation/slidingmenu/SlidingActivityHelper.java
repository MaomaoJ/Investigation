package com.investigation.slidingmenu;
...
public class SlidingActivityHelper {
	...
	private SlidingMenu mSlidingMenu;//һ�����֣�MainActivity��initSlidingMenu()����getSlidingMenu()���صľ�����
	                                   //��������ӿɲ���mSlidingMenumain.xml��չʾ
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//mSlidingMenu = (SlidingMenu)inflater.inflate(R.layout.slidingmenumain, null);
		//mSlidingMenu = new SlidingMenu(inflater.inflate(R.layout.slidingmenumain, null).getContext());
	}
